<?php
require_once 'stimulsoft/JS/stimulsoft/classes.php';
require_once 'stimulsoft/JS/stimulsoft/adapters/mysql.php';
require_once 'stimulsoft/JS/stimulsoft/adapters/mssql.php';
require_once 'stimulsoft/JS/stimulsoft/adapters/firebird.php';
require_once 'stimulsoft/JS/stimulsoft/adapters/postgresql.php';
require_once 'stimulsoft/JS/stimulsoft/adapters/oracle.php';
require_once 'stimulsoft/JS/stimulsoft/email/class.phpmailer.php';
require_once 'stimulsoft/JS/stimulsoft/email/class.pop3.php';
require_once 'stimulsoft/JS/stimulsoft/email/class.smtp.php';
require_once 'stimulsoft/JS/stimulsoft/email/PHPMailerAutoload.php';
...
class StiHelper {
	public static function initialize($url = "../stimulsoft/JS/handler.php", $timeout = 30) {
		...
		StiHelper.prototype.process = function (obj, callback) {
			if (obj != null) {
				...
				for (var p in obj) {
					...
					else if (p == "settings" && obj.settings != null) command.settings = obj.settings;
