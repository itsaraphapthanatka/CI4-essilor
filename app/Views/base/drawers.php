				...
				<div id="kt_app_footer" class="app-footer">
					...
					<div class="app-container container-fluid d-flex flex-column flex-md-row flex-center flex-md-stack py-3">
						...
						<div class="text-dark order-2 order-md-1">
							...
							<a href="https://appreview.co.th" target="_blank" class="text-gray-800 text-hover-primary">App Review</a>
						</div>
						<!--end::Copyright-->
						<!--begin::Menu-->
						<ul class="menu menu-gray-600 menu-hover-primary fw-semibold order-1">
							<li class="menu-item">
								<a href="https://appreview.co.th" target="_blank" class="menu-link px-2">About</a>
							</li>
							<li class="menu-item">
								<a href="https://appreview.co.th" target="_blank" class="menu-link px-2">Support</a>
							</li>
						</ul>
						<!--end::Menu-->
					</div>
							...
							<div class="pe-3 mb-5">
								...
								<div class="d-flex align-items-center mt-1 fs-6">
									...
									<div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Nina Nilson">
										<img src="<?php echo base_url();?>theme/dist/assets/media/avatars/300-14.jpg" alt="img" />
									</div>
									<!--end::User-->
								</div>
								<!--end::Description-->
							...
							<div class="overflow-auto pb-5">
								...
								<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-5">
									...
									<div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px pe-2">
										...
										<div class="symbol symbol-circle symbol-25px">
											<img src="<?php echo base_url();?>theme/dist/assets/media/avatars/300-2.jpg" alt="img" />
										</div>
										<!--end::User-->
										<!--begin::User-->
										<div class="symbol symbol-circle symbol-25px">
								...
								<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-0">
									...
									<div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px">
										<!--begin::User-->
										<div class="symbol symbol-circle symbol-25px">
											<img src="<?php echo base_url();?>theme/dist/assets/media/avatars/300-20.jpg" alt="img" />
										</div>
										<!--end::User-->
										<!--begin::User-->
										<div class="symbol symbol-circle symbol-25px">
							...
							<div class="overflow-auto pe-3">
								...
								<div class="d-flex align-items-center mt-1 fs-6">
									...
									<div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Alan Nilson">
										<img src="<?php echo base_url();?>theme/dist/assets/media/avatars/300-1.jpg" alt="img" />
									</div>
									<!--end::User-->
								</div>
								<!--end::Description-->
							...
							<div class="mb-5 pe-3">
								...
								<div class="d-flex align-items-center mt-1 fs-6">
									...
									<div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Jan Hummer">
										<img src="<?php echo base_url();?>theme/dist/assets/media/avatars/300-23.jpg" alt="img" />
									</div>
									<!--end::User-->
								</div>
								<!--end::Description-->
							...
							<div class="overflow-auto pb-5">
								<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
									...
									<div class="d-flex flex-aligns-center pe-10 pe-lg-20">
										<!--begin::Icon-->
										<img alt="" class="w-30px me-3" src="<?php echo base_url();?>theme/dist/assets/media/svg/files/pdf.svg" />
										<!--end::Icon-->
										<!--begin::Info-->
									...
									<div class="d-flex flex-aligns-center pe-10 pe-lg-20">
										<!--begin::Icon-->
										<img alt="../../demo1/dist/apps/projects/project.html" class="w-30px me-3" src="<?php echo base_url();?>theme/dist/assets/media/svg/files/doc.svg" />
										<!--end::Icon-->
										<!--begin::Info-->
										<div class="ms-1 fw-semibold">
											<!--begin::Desc-->
									...
									<div class="d-flex flex-aligns-center">
										<!--begin::Icon-->
										<img alt="../../demo1/dist/apps/projects/project.html" class="w-30px me-3" src="<?php echo base_url();?>theme/dist/assets/media/svg/files/css.svg" />
										<!--end::Icon-->
										<!--begin::Info-->
										<div class="ms-1 fw-semibold">
											<!--begin::Desc-->
								...
								<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-7">
									...
									<div class="overlay me-10">
										...
										<div class="overlay-wrapper">
											<img alt="img" class="rounded w-150px" src="<?php echo base_url();?>theme/dist/assets/media/stock/600x400/img-29.jpg" />
										</div>
										<!--end::Image-->
										<!--begin::Link-->
									...
									<div class="overlay me-10">
										<!--begin::Image-->
										<div class="overlay-wrapper">
											<img alt="img" class="rounded w-150px" src="<?php echo base_url();?>theme/dist/assets/media/stock/600x400/img-31.jpg" />
										</div>
										<!--end::Image-->
										<!--begin::Link-->
										<div class="overlay-layer bg-dark bg-opacity-10 rounded">
									...
									<div class="overlay">
										<!--begin::Image-->
										<div class="overlay-wrapper">
											<img alt="img" class="rounded w-150px" src="<?php echo base_url();?>theme/dist/assets/media/stock/600x400/img-40.jpg" />
										</div>
										<!--end::Image-->
										<!--begin::Link-->
										<div class="overlay-layer bg-dark bg-opacity-10 rounded">
							...
							<div class="pe-3 mb-5">
								...
								<div class="d-flex align-items-center mt-1 fs-6">
									...
									<div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Robert Rich">
										<img src="<?php echo base_url();?>theme/dist/assets/media/avatars/300-4.jpg" alt="img" />
									</div>
									<!--end::User-->
								</div>
								<!--end::Description-->
					...
					<div class="d-flex flex-column align-items-start">
						...
						<div class="d-flex align-items-center mb-2">
							...
							<div class="symbol symbol-35px symbol-circle">
								<img alt="Pic" src="<?php echo base_url();?>theme/dist/assets/media/avatars/300-25.jpg" />
							</div>
							<!--end::Avatar-->
							<!--begin::Details-->
							<div class="ms-3">
		...
		<div class="card-body hover-scroll-overlay-y h-400px pt-5">
			...
			<div class="d-flex flex-stack">
				...
				<div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
					<img src="<?php echo base_url();?>theme/dist/assets/media/stock/600x400/img-1.jpg" alt="" />
				</div>
				<!--end::Pic-->
			</div>
			<!--end::Item-->
			...
			<div class="d-flex flex-stack">
				...
				<!--begin::Pic-->
				<div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
					<img src="<?php echo base_url();?>theme/dist/assets/media/stock/600x400/img-3.jpg" alt="" />
				</div>
				<!--end::Pic-->
			</div>
			<!--end::Item-->
			...
			<div class="d-flex flex-stack">
				...
				<!--begin::Pic-->
				<div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
					<img src="<?php echo base_url();?>theme/dist/assets/media/stock/600x400/img-8.jpg" alt="" />
				</div>
				<!--end::Pic-->
			</div>
			<!--end::Item-->
			...
			<div class="d-flex flex-stack">
				...
				<!--begin::Pic-->
				<div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
					<img src="<?php echo base_url();?>theme/dist/assets/media/stock/600x400/img-26.jpg" alt="" />
				</div>
				<!--end::Pic-->
			</div>
			<!--end::Item-->
			...
			<div class="d-flex flex-stack">
				...
				<!--begin::Pic-->
				<div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
					<img src="<?php echo base_url();?>theme/dist/assets/media/stock/600x400/img-21.jpg" alt="" />
				</div>
				<!--end::Pic-->
			</div>
			<!--end::Item-->
			...
			<div class="d-flex flex-stack">
				...
				<!--begin::Pic-->
				<div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
					<img src="<?php echo base_url();?>theme/dist/assets/media/stock/600x400/img-34.jpg" alt="" />
				</div>
				<!--end::Pic-->
			</div>
			<!--end::Item-->
			...
			<div class="d-flex flex-stack">
				...
				<!--begin::Pic-->
				<div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
					<img src="<?php echo base_url();?>theme/dist/assets/media/stock/600x400/img-27.jpg" alt="" />
				</div>
				<!--end::Pic-->
			</div>
			<!--end::Item-->
