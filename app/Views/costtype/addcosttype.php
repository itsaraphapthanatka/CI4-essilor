				...
				<form id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row" method="post" action="/EditProject" enctype="multipart/form-data">
					...
					<div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                                        ...
                                        <div class="card-body pt-0">
                                            <div class="d-flex flex-wrap gap-5">
                                                ...
                                                <div class="mb-10 fv-row w-100 flex-md-root">
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <input type="text" name="costtypecode" class="form-control mb-2" placeholder="Cost Type Code" value="" />
                                                    <!--end::Input-->
                                                </div>
                                                <!--end::Input group-->
                                            </div>
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" name="costtypename" class="form-control mb-2" placeholder="Cost Type Name" value="" />
                                                <!--end::Input-->
                                            </div>
                                            <!--end::Input group-->
                                            <!--begin::Input group-->
						...
						<div class="d-flex justify-content-end">
							<!--begin::Button-->
							<a href="/setupCostType/<?=$seq1;?>/<?=$seq2;?>/<?=$seq3;?>" id="kt_ecommerce_add_product_cancel" class="btn btn-light me-5">Cancel</a>
							<!--end::Button-->
							<!--begin::Button-->
