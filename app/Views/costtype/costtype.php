		...
		<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
			...
			<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
				...
				<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
					...
					<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Setup Cost Type</h1>
					<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
						...
						<!--begin::Item-->
							<li class="breadcrumb-item text-muted">
								<a href="/setupCostType/<?=$seq1;?>/<?=$seq2;?>/<?=$seq3;?>" class="text-muted text-hover-primary">Setup Cost Type</a>
							</li>
						<!--end::Item-->	
					</ul>
					<!--end::Title-->
				...
				<div class="card">
					...
					<div class="card-header border-0 pt-6">
						...
						<div class="card-toolbar flex-row-fluid justify-content-end gap-5">
							...
							<a href="/addCostType/<?=$seq1;?>/<?=$seq2;?>/<?=$seq3;?>" type="button" class="btn btn-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
                ...
                <div class="card-body py-4">
                    ...
                    <table id="kt_datatable_horizontal_scroll" class="table align-middle table-row-dashed fs-6 gy-5" >
                        ...
                        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                            <th class="min-w-100px">Cost Type Code</th>
                            <th class="min-w-125px">Cost Type Name</th>
...
<script>
	...
	var KTDatatablesServerSide = function () {
		...
		var channalid = '10';
		var userlist = "jsondata/getcostType";
		var type_status = {
						...
						render: function (data, type, row) {
								...
								<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-200px py-4" data-kt-menu="true">									
									<div class="menu-item px-3">
										<a href="/editCostType/<?=$seq1;?>/<?=$seq2;?>/<?=$seq3;?>/${row.costtype_id}" class="menu-link px-3" data-kt-docs-table-filter="edit_row">
											Edit
										</a>
									</div>
									<!--end::Menu item-->
