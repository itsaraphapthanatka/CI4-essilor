...
<div class="toolbar py-3 py-lg-6" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap gap-2">
        ...
        <div class="d-flex align-items-center">
            <button type="button" class="btn btn-success me-3">Upload</button>
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                        <!--begin::Button-->
                        <a href="#" class="btn btn-icon btn-color-muted bg-light me-3" data-bs-toggle="modal" data-bs-target="#kt_modal_upgrade_plan">
                            <i class="ki-duotone ki-abstract-28                        ">
                                <span class="path1"></span>
                                <span class="path2"></span>
                            </i>
                        </a>
                        <!--end::Button-->
                        <!--begin::Button-->
                        <a href="#" class="btn btn-icon btn-color-primary bg-light w-35px h-35px w-lg-40px h-lg-40px me-3" data-bs-toggle="modal" data-bs-target="#kt_modal_create_campaign">
                            <i class="ki-duotone ki-row-horizontal                        ">
                                <span class="path1"></span>
                                <span class="path2"></span>
                            </i>
                        </a>
                        <!--end::Button-->
                        <!--begin::Daterange-->
                        <a href="#" class="btn btn-flex bg-light h-35px h-lg-40px px-5" id="kt_dashboard_daterangepicker" data-bs-toggle="tooltip" data-bs-dismiss="click" data-bs-trigger="hover" title="Select dashboard daterange">
                            <span class="me-4">
                                <span class="text-muted fw-semibold me-1" id="kt_dashboard_daterangepicker_title">Filter</span>
                                <span class="text-primary fw-bold" id="kt_dashboard_daterangepicker_date">4</span>
                            </span>
                        </a>
                        <!--end::Daterange-->
                    </div>
