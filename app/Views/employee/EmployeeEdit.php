		...
		<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
			...
			<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
				...
				<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
					<!--begin::Title-->
					<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Edit Employee <?=$empid;?></h1>
					<!--end::Title-->
				</div>
				<!--end::Page title-->
			</div>
							...
							<div class="card card-flush py-4">
								...
								<div class="card-body">
									<ul class="nav nav-tabs nav-line-tabs nav-line-tabs-2x mb-10 fs-3 fw-bold">
										...
										<li class="nav-item">
											<a class="nav-link" data-bs-toggle="tab" href="#kt_tab_pane_3">Signature</a>
										</li>
									</ul>
													...
													<div class="col-lg-10">
														...
														<div class="fv-row mb-10">
															...
															<div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url(/assets/media/svg/avatars/blank.svg)">
																...
																<div class="image-input-wrapper w-300px h-150px" style="background-image: url(/theme/dist/assets/media/svg/files/blank-image.svg); background-size: 300px 150px; background-repeat: no-repeat;"></div>
