		...
		<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
			...
			<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
				...
				<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
					<!--begin::Title-->
					<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Setup Cost Control</h1>
					<!--end::Title-->
					<!--begin::Breadcrumb-->
					<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
						...
						<!--end::Item-->
						<!--begin::Item-->
						<li class="breadcrumb-item text-muted">Setup Cost Control</li>
						<!--end::Item-->
					</ul>
					<!--end::Breadcrumb-->
				</div>
					...
					<div class="card-header pt-8">
						<div class="card-title">
							...
							<div class="d-flex align-items-center position-relative my-1">
								...
								<input type="text" data-kt-filemanager-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Cost Type" />
							</div>
							<!--end::Search-->
						</div>
						<!--begin::Card toolbar-->
...
<script>
	...
	var KTDatatablesServerSide = function () {
		...
		var channalid = '10';
		var userlist = "jsondata/getCostControlType";
		var type_status = {
				...
				columnDefs: [
					...
					},
                    {
						...
						render: function(data, type, row) {
							if(row.ctype_name == null){
								return `<a href="/setupCostControlgroup/<?=$seq1;?>/<?=$seq2;?>/<?=$seq3;?>/${row.ctype_code}">-</a>`;
							}else{
								return `<a href="/setupCostControlgroup/<?=$seq1;?>/<?=$seq2;?>/<?=$seq3;?>/${row.ctype_code}">${row.ctype_name}</a>`;
							}
						...
						render: function (data, type, row) {
								...
								<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-200px py-4" data-kt-menu="true">									
									<div class="menu-item px-3">
										<a href="/departmentUnitEdit/<?=$seq1;?>/<?=$seq2;?>/<?=$seq3;?>/${row.mattype_code}" class="menu-link px-3" data-kt-docs-table-filter="edit_row">
											Edit
										</a>
									</div>
									<!--end::Menu item-->
