		...
		<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
			...
			<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
				...
				<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
					<!--begin::Title-->
					<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Setup Cost Group</h1>
					<!--end::Title-->
					<!--begin::Breadcrumb-->
					<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
						...
						<!--end::Item-->
						<!--begin::Item-->
						<li class="breadcrumb-item text-muted">Setup Cost Group</li>
						<!--end::Item-->
					</ul>
					<!--end::Breadcrumb-->
				</div>
					...
					<div class="card-header pt-8">
						<div class="card-title">
							...
							<div class="d-flex align-items-center position-relative my-1">
								...
								<input type="text" data-kt-filemanager-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Cost Group" />
							</div>
							<!--end::Search-->
						</div>
						<!--begin::Card toolbar-->
...
<script>
	...
	var KTDatatablesServerSide = function () {
		...
		var userlist = "jsondata/getCostControlGroup/"+cost_type;
		var type_status = {
		...
		var initDatatable = function () {
			dt = $("#kt_datatable_").DataTable({
				...
				columnDefs: [
                    {
                        targets: 0, // ctype_code
					},
                    {
                        targets: 1, // ctype_name
						render: function(data, type, row) {
							return `<a href="/setupCostControlsubGroup/<?=$seq1;?>/<?=$seq2;?>/<?=$seq3;?>/${row.ctype_code}/${row.cgroup_code}">${row.cgroup_name}</a>`;
						}
					},
                    {
                        targets: 2, //สถานะ
						...
						render: function (data, type, row) {
								...
								<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-200px py-4" data-kt-menu="true">									
									<div class="menu-item px-3">
										<a href="/setupMaterialgroup/<?=$seq1;?>/<?=$seq2;?>/<?=$seq3;?>/${row.matgroup_id}" class="menu-link px-3" data-kt-docs-table-filter="edit_row">
											Edit
										</a>
									</div>
									<!--end::Menu item-->
