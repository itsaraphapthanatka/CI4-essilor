		...
		<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
			...
			<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
				...
				<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
					<!--begin::Title-->
					<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Setup Cost Subgroup</h1>
					<!--end::Title-->
					<!--begin::Breadcrumb-->
					<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
						...
						<!--end::Item-->
						<!--begin::Item-->
						<li class="breadcrumb-item text-muted">Setup Cost Subgroup</li>
						<!--end::Item-->
					</ul>
					<!--end::Breadcrumb-->
				</div>
					...
					<div class="card-header pt-8">
						<div class="card-title">
							...
							<div class="d-flex align-items-center position-relative my-1">
								...
								<input type="text" data-kt-filemanager-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Cost Subgroup" />
							</div>
							<!--end::Search-->
						</div>
						<!--begin::Card toolbar-->
					...
					<div class="card-body">
						...
						<div class="d-flex flex-stack">
							...
							<div class="badge badge-lg badge-light-primary">
								<div class="d-flex align-items-center flex-wrap">
									...
									<a href="/setupCostCode/<?=$seq1;?>/<?=$seq2;?>/<?=$seq3;?>">[<?=$type['ctype_code']?>]<?=$type['ctype_name'];?></a>
									<i class="ki-duotone ki-right fs-2 text-primary mx-1"></i>
									<a href="/setupCostControlgroup/<?=$seq1;?>/<?=$seq2;?>/<?=$seq3;?>/<?=$cost_type;?>/<?=$cost_group;?>">[<?=$group['cgroup_code'];?>] <?=$group['cgroup_name'];?></a>
									<!-- <i class="ki-duotone ki-right fs-2 text-primary mx-1"></i>
									<a href="#">html</a>
									<i class="ki-duotone ki-right fs-2 text-primary mx-1"></i>
									demo1 -->
						...
						<div class="d-flex flex-stack">
							...
							<div class="badge badge-lg badge-light-success">
								...
								<div id="costcode"><?=$type['ctype_code']?><?=$group['cgroup_code'];?></div>
							</div>
							</div>
							<!--end::Folder path-->
						</div>
...
<script>
	...
	var KTDatatablesServerSide = function () {
        ...
        var cost_group = "<?=$cost_group?>";
        console.log(cost_type);
        console.log(cost_group);
		var userlist = "jsondata/getCostControlsubGroup/"+cost_type+"/"+cost_group;
		var type_status = {
				...
				columnDefs: [
					...
					},
                    {
						...
						render: function(data, type, row) {
							// return `<a href="/setupCostControlProduct/<?=$seq1;?>/<?=$seq2;?>/<?=$seq3;?>/${row.ctype_code}/${row.cgroup_code}/${row.csubgroup_code}">${row.csubgroup_name}</a>`;
							return `<a href="#" data-kt-docs-table="click_row">${row.csubgroup_name}</a>`;
						}
					},
                    {
                        targets: 2, //สถานะ
		...
		var handleClickRows = () => {
            const clickRows = document.querySelectorAll('[data-kt-docs-table="click_row"]');
            clickRows.forEach(d => {
                d.addEventListener('click', function (e) {
                    e.preventDefault();
                    const parent = e.target.closest('tr');
                    ...
                    document.getElementById('costcode').innerHTML = "<?=$type['ctype_code'];?><?=$group['cgroup_code'];?>"+id;
                })
            });
        }
